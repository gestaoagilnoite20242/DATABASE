...
CREATE OR REPLACE FUNCTION agenda.inserir_ritmo_trabalho(prestador_id INT, dia_semana CHAR(20), hora_inicio TIME, hora_fim TIME)
RETURNS VOID AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION agenda.deletar_ritmo_trabalho(ritmo_id INT)
RETURNS VOID AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION agenda.listar_ritmo_trabalho_prestador(p_prestador_id INT)
RETURNS TABLE(
    id INT,
    dia_semana CHAR(20),
    hora_inicio TIME,
